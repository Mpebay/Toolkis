...
const Cart = () => {
  return (
    ...
    <div className='w-full min-h-32 bg-[#053b50] text-xl text-white p-5 justify-between items-center flex gap-2 '>
        <div>
            <img className='w-10 h-8 md:hidden' src="./public/descarga.png" alt="" />
        </div>
        ...
        <div className='w-full min-h-screen bg-[#f0ebe3] flex items-center flex-col gap-3'>
            ...
            <div className='w-5/6 h-20 bg-gray-400 flex items-center gap-2 rounded-lg p-2 justify-around relative shadow-md hover:scale-110 transform duration-300 cursor-pointer'>
                ...
                <input className='w-10 text-center rounded-md' type="number" name="" id="" />
            ...
            <div className='w-5/6 text-sm flex gap-2 justify-between'>
                <button className='bg-[#7D9D9C] rounded-md p-2 hover:bg-sky-700 hover:scale-110 transform duration-300'>Add more products</button>
                <button className='bg-[#576F72] rounded-md p-2 hover:bg-sky-700 hover:scale-110 transform duration-300'>Complete purchase</button>
            </div>
